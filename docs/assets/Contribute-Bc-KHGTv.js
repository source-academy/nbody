...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"enhancement"})," Provide more predefined simulate functions"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"enhancement"})," Allow users to use custom shapes/textures for bodies"]}),`
