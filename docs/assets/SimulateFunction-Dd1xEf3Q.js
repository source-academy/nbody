...
`,e.jsxs(t.p,{children:["A ",e.jsx(t.a,{href:"https://en.wikipedia.org/wiki/Verlet_integration#Velocity_Verlet",rel:"nofollow",children:"velocity verlet"})," integrator implementation. Uses newtonian gravity by default, or the provided force object."]}),`
...
`,e.jsxs(t.p,{children:["An ",e.jsx(t.a,{href:"https://en.wikipedia.org/wiki/Explicit_and_implicit_methods",rel:"nofollow",children:"explicit euler"})," integrator implementation. Uses newtonian gravity by default, or the provided force object."]}),`
...
`,e.jsxs(t.p,{children:["A ",e.jsx(t.a,{href:"https://en.wikipedia.org/wiki/Explicit_and_implicit_methods",rel:"nofollow",children:"semi-implicit euler"})," integrator implementation. Uses newtonian gravity by default, or the provided force object."]}),`
...
`,e.jsxs(t.p,{children:["A ",e.jsx(t.a,{href:"https://en.wikipedia.org/wiki/Runge%E2%80%93Kutta_methods",rel:"nofollow",children:"runge-kutta order 4"})," integrator implementation. Uses newtonian gravity by default, or the provided force object. Optionally, you can provide the weight coefficients for the averaging step."]}),`
...
`,e.jsx(t.p,{children:"A simulate function based the given lambda/arrow/anonymous function."}),`
...
`})})]})}function j(n={}){const{wrapper:t}={...r(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{j as default};
